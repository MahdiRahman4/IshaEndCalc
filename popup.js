...
function showMidnight(midnight,meridian){
    ...
    const date = new Date();
        ...
        midnightDate.setHours(parseInt(midnight.split(":")[0]));
        midnightDate.setMinutes(parseInt(midnight.split(":")[1]));
        midnightDate.setSeconds(0);
    
        if (meridian === "PM" && midnightDate.getHours() !== 12) {
            midnightDate.setHours(midnightDate.getHours() + 12);
        }
